...
import { TaskLog as GlobalTaskLog, Reflectie, Task } from '@/types';
...
interface ComponentTaskLog extends Omit<GlobalTaskLog, 'tasks'> {
  tasks?: {
    titel: string;
  } | null | undefined;
}
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex border-b border-gray-200 mb-6">
        <button
          ...
          className={`px-4 py-2 font-medium text-sm ${activeTab === 'dag'
        ...
        <button
          ...
          className={`px-4 py-2 font-medium text-sm ${activeTab === 'week'
            ? 'text-purple-600 border-b-2 border-purple-600'
            : 'text-gray-500 hover:text-gray-700'
            }`}
        >
